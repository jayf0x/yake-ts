...
export const ENGLISH_STOPWORDS: ReadonlySet<string> = new Set([
  "dr", "dra", "mr", "ms", "a", "a's", "able", "about", "above", "according",
  ...
  "follows", "for", "former", "formerly", "forth", "four", "from", "further", "furthermore", "g",
  ...
  "hither", "hopefully", "how", "howbeit", "however", "i", "i'd", "i'll", "i'm", "i've",
  ...
  "it'll", "it's", "its", "itself", "j", "just", "k", "keep", "keeps", "kept",
  ...
  "uucp", "v", "value", "various", "very", "via", "viz", "vs", "w", "want",
  ...
  "while", "whither", "who", "who's", "whoever", "whole", "whom", "whose", "why", "will",
